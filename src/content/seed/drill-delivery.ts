...
export const DRILL_DELIVERY: DrillItem[] = [
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'The end users whose daily workflow the system will change', whyWrong: 'Valuable, and they cannot block you the way an unconsulted security lead can.' },
        { id: 'b', text: 'Two more engineers, so the build starts at full capacity', whyWrong: 'Capacity is rarely the week-one constraint. Permission to proceed is.' },
        { id: 'c', text: 'Security, legal, and the owners of the systems you touch' },
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'That these are curated, and the date the real data lands' },
        ...
        { id: 'c', text: 'That the results so far should all be treated as preliminary', whyWrong: 'Vague enough to be heard as modesty rather than as a material caveat.' },
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Update the project plan and republish it to both teams', whyWrong: 'Necessary, and a plan nobody on their side confirmed is still not an agreement.' },
        { id: 'b', text: 'Send a short written summary of the agreement, today' },
        { id: 'c', text: 'Brief your own team so everyone works to the new date', whyWrong: 'Internal only. The recollection that gets disputed later is the customer’s.' },
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Let them finish, then say back what went wrong' },
        { id: 'b', text: 'Apologize at once and move straight to the fix', whyWrong: 'Rushes past the part where they need to be certain you understood the damage.' },
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: '"Which date on your side is truly immovable for you, and why?"', whyWrong: 'You get a date and a reason. Deadlines squeeze the plan; they rarely reshape the design.' },
        { id: 'b', text: '"Who else needs to approve this before we can start?"', whyWrong: 'Genuinely valuable, and second to surfacing a constraint nobody has volunteered.' },
        { id: 'c', text: '"What constraint have we not discussed that changes this?"' },
        { id: 'd', text: '"What does success look like six months after launch?"', whyWrong: 'Essential, and you should already have asked it earlier in the same call.' },
      ],
      correctId: 'c',
    },
  },
