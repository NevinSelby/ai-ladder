...
export const DRILL_SCALE_PROD: DrillItem[] = [
  // ── Scaling & reliability ────────────────────────────────────────────────
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'What the peak minute looks like and when it happens' },
        { id: 'b', text: 'What the monthly total is', whyWrong: 'The same number at a coarser resolution, it hides the shape even further.' },
        { id: 'c', text: 'How many users there are', whyWrong: 'Useful context, and it does not tell you the concurrency you must survive.' },
        { id: 'd', text: 'What their current latency is', whyWrong: 'A different question, and answered after you know the load shape.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Put a connection pooler in front of the database and give each instance a small pool' },
        { id: 'b', text: 'Raise max_connections on the database', whyWrong: 'Each connection costs memory; you trade a connection error for an out-of-memory one.' },
        { id: 'c', text: 'Add a read replica', whyWrong: 'Splits read load and does nothing about connection count from the write path.' },
        { id: 'd', text: 'Cap concurrent instances', whyWrong: 'Caps your throughput to work around a pooling problem.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Isolate them onto dedicated capacity, and price that isolation' },
        { id: 'b', text: 'Rate limit them to the average tenant’s quota', whyWrong: 'Punishes your largest customer for being large. That conversation goes badly.' },
        { id: 'c', text: 'Scale the shared tier for their peak', whyWrong: 'Everyone pays for one tenant’s peak, permanently.' },
        { id: 'd', text: 'Add a cache in front', whyWrong: 'Helps if their traffic is cacheable; it does not address the noisy-neighbor structure.' },
      ],
      correctId: 'a',
    },
  },
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Serve the unranked results with a visible note that quality is reduced' },
        { id: 'b', text: 'Return an error until the reranker recovers', whyWrong: 'Withholds a usable answer over a quality optimization.' },
        { id: 'c', text: 'Silently skip reranking', whyWrong: 'Users experience unexplained worse answers and lose trust in the whole system.' },
        { id: 'd', text: 'Retry the reranker until it responds', whyWrong: 'Turns a degraded feature into a hung request.' },
      ],
      correctId: 'a',
    },
  },
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Give it a batch tool that accepts a list of ids' },
        { id: 'b', text: 'Run the tool calls in parallel', whyWrong: 'Better wall-clock and still 400 calls hammering the customer’s API quota.' },
        { id: 'c', text: 'Increase the agent step limit', whyWrong: 'Permits the problem rather than removing it.' },
        { id: 'd', text: 'Use a faster model', whyWrong: 'The time is in the tool calls, not in generation.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Set a minimum instance count of one and price the idle cost' },
        { id: 'b', text: 'Move to always-on VMs', whyWrong: 'Overcorrects, and adds patching and capacity management for a low-traffic tool.' },
        { id: 'c', text: 'Have the client retry on timeout', whyWrong: 'Makes the user wait twice.' },
        { id: 'd', text: 'Ping the service on a schedule to keep it warm', whyWrong: 'The hack that predates minimum instances, and it breaks silently when the schedule stops.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Put the work behind a queue and drain it at a rate the downstream can sustain' },
        { id: 'b', text: 'Autoscale to meet the spike', whyWrong: 'Possible, and you pay for peak capacity and push the spike onto every downstream dependency.' },
        { id: 'c', text: 'Reject work above the steady rate', whyWrong: 'Drops the customer’s data.' },
        { id: 'd', text: 'Process it synchronously with a long timeout', whyWrong: 'Ties up capacity and fails as a unit.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'The failover region must also be in the EU, which narrows the available regions and service configurations' },
        { id: 'b', text: 'Nothing: DR replication is exempt from residency', whyWrong: 'It is not. A replica is a copy of the data in another place.' },
        { id: 'c', text: 'Only backups need to stay in region', whyWrong: 'Replicas are live copies and are squarely in scope.' },
        { id: 'd', text: 'Encryption in transit is sufficient', whyWrong: 'Residency is about where data rests and is processed, not how it travels.' },
      ],
      correctId: 'a',
    },
  },
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'A pre-agreed online signal you watch during the ramp, with a threshold that triggers rollback' },
        { id: 'b', text: 'Waiting 24 hours before increasing the percentage', whyWrong: 'Time without a metric is just delay.' },
        { id: 'c', text: 'Rolling out to internal users first', whyWrong: 'Useful and not representative of real traffic or real questions.' },
        { id: 'd', text: 'Having a rollback plan documented', whyWrong: 'Necessary, and it only helps if something tells you to use it.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Otherwise the provider can change your behavior without any deployment on your side' },
        { id: 'b', text: 'Pinned versions are cheaper', whyWrong: 'Pricing is per model, not per pinning strategy.' },
        { id: 'c', text: 'Aliases are less reliable', whyWrong: 'Availability is the same; predictability is what differs.' },
        { id: 'd', text: 'Pinning improves latency', whyWrong: 'No relationship.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'The system accepts both old and new credentials during an overlap window' },
        { id: 'b', text: 'A calendar reminder every 90 days', whyWrong: 'Reminds you to do the scary thing; does not make it less scary.' },
        { id: 'c', text: 'Documenting the procedure thoroughly', whyWrong: 'A long document describing a risky simultaneous change still gets deferred.' },
        { id: 'd', text: 'Rotating during a maintenance window', whyWrong: 'Makes it a bigger event, so it happens less often.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Error budget burning fast enough to breach the SLO, or a user-visible failure rate above threshold' },
        { id: 'b', text: 'CPU above 80%', whyWrong: 'Often entirely healthy. Pages for this teach people to ignore the pager.' },
        { id: 'c', text: 'Any error in the logs', whyWrong: 'Guarantees alert fatigue within a week.' },
        { id: 'd', text: 'A deployment completing', whyWrong: 'Information, not an incident.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'What is affected, what you are doing, and the time of your next update' },
        { id: 'b', text: 'Wait until you understand the cause', whyWrong: 'Silence during an outage is read as absence, and they will escalate.' },
        { id: 'c', text: 'A preliminary root cause you are fairly confident about', whyWrong: 'Early theories are usually wrong, and retracting one costs more trust than saying you do not know.' },
        { id: 'd', text: 'An apology and a service credit offer', whyWrong: 'Premature, and it substitutes commercial remedy for information they need now.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'Hourly spend anomaly alerting plus a hard per-run token budget' },
        { id: 'b', text: 'A monthly budget alert', whyWrong: 'Fires days later, after the money is gone.' },
        { id: 'c', text: 'Reviewing the bill each month', whyWrong: 'Detective at the worst possible latency.' },
        { id: 'd', text: 'A cheaper model', whyWrong: 'Makes the runaway slower to notice, not less likely.' },
      ],
      correctId: 'a',
    },
  },
  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'The model provider returning sustained 503s, to see whether degradation and user messaging actually work' },
        { id: 'b', text: 'A database failover', whyWrong: 'Worth testing, and the managed service already handles it; the AI dependency is the newer, less-exercised path.' },
        { id: 'c', text: 'Loss of an entire region', whyWrong: 'Rarely in scope for a pilot and expensive to rehearse.' },
        { id: 'd', text: 'A corrupted deployment', whyWrong: 'Your pipeline should prevent it; the dependency failure is outside your control and therefore more likely.' },
      ],
      correctId: 'a',
    },
  },
  {
    ...
    payload: {
      ...
      choices: [
        { id: 'a', text: 'It runs in their CI, with their credentials, and their team has used it to ship a change' },
        { id: 'b', text: 'The pipeline definition is documented', whyWrong: 'Documentation of a thing they have never run.' },
        { id: 'c', text: 'They have access to your CI system', whyWrong: 'Leaves the dependency on your infrastructure and your billing.' },
        { id: 'd', text: 'The deploy is a single command', whyWrong: 'Convenient, and it says nothing about who can actually run it.' },
      ],
      correctId: 'a',
    },
  },
