  ...
  },
  {
    ...
    payload: {
      ...
      choices: [
        ...
        { id: 'd', text: 'Device authorization grant: show a code, approve elsewhere, poll for a token' },
      ],
      correctId: 'd',
    },
  },
  ...
  // ── Agent identity & delegation ──────────────────────────────────────────
  {
    ...
    payload: {
      ...
      choices: [
        ...
        { id: 'd', text: 'Three: the agent, the user, and the model provider serving the inference', whyWrong: 'The model provider is a subprocessor in the data path, not a principal in your authorization decision.' },
      ],
      correctId: 'a',
    },
  },
